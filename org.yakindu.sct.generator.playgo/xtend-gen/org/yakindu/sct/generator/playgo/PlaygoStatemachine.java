...
public class PlaygoStatemachine extends Statemachine {
  ...
  protected CharSequence systemEvent(final ExecutionFlow flow) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("ebridge.systemEvent(this.getClass().getSimpleName(), selfClassName, selfObjectName, eventName);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("} else {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("ebridge.systemEventSelfExcluded(this.getClass().getSimpleName(), selfClassName, selfObjectName, targetClassName, eventName);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    CharSequence _xblockexpression = null;
    {
      ...
      StringConcatenation _builder = new StringConcatenation();
      {
        ...
        if (_and) {
          ...
          _builder.append("\", selfObjectName, \"raise");
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("System.out.println(\"in \" + \"");
          _builder.append(className, "\t");
          _builder.append(".\" +\"raise");
          String _name_2 = event.getName();
          String _asName_2 = this._naming.asName(_name_2);
          _builder.append(_asName_2, "\t");
          _builder.append("\" + \"[\" + selfObjectName+ \":\" + selfClassName + \"]\");");
          _builder.newLineIfNotEmpty();
          _builder.append("}");
          _builder.newLine();
          _builder.newLine();
          ...
          String _asIdentifier_1 = this._naming.asIdentifier(_name_4);
          ...
          String _asName_3 = this._naming.asName(_name_5);
          ...
          String _asName_4 = this._naming.asName(_name_6);
          _builder.append(_asName_4, "");
          _builder.append("() {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          ...
          String _asName_5 = this._naming.asName(_name_8);
          ...
          String _asIdentifier_2 = this._naming.asIdentifier(_name_9);
          _builder.append(_asIdentifier_2, "");
          _builder.append("() {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          ...
          String _asIdentifier_3 = this._naming.asIdentifier(_name_10);
          _builder.append(_asIdentifier_3, "\t");
          _builder.append("\"+ \"[\" + selfObjectName+ \":\" + selfClassName + \"]\");");
          _builder.newLineIfNotEmpty();
          _builder.append("}");
          _builder.newLine();
        ...
        if (_and) {
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            if (_createInterfaceObserver) {
              ...
              _builder.append(".\" +\"raise");
              String _name_4 = event.getName();
              String _asName_2 = this._naming.asName(_name_4);
              _builder.append(_asName_2, "\t");
              _builder.append("\" + \"[\" + selfObjectName+ \":\" + selfClassName + \"]\");");
              _builder.newLineIfNotEmpty();
            }
          ...
          _builder.append(".\" +\"");
          String _name_7 = event.getName();
          String _asIdentifier_1 = this._naming.asIdentifier(_name_7);
          _builder.append(_asIdentifier_1, "\t");
          _builder.append("\" + \"[\" + selfObjectName+ \":\" + selfClassName + \"]\");");
          _builder.newLineIfNotEmpty();
          _builder.append("}");
          ...
          _builder.append("private void raise");
          String _name_9 = event.getName();
          String _asName_4 = this._naming.asName(_name_9);
          _builder.append(_asName_4, "");
          _builder.append("() {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            if (_createInterfaceObserver_2) {
              ...
              _builder.append("listener.on");
              String _name_10 = event.getName();
              String _asEscapedName_2 = this._naming.asEscapedName(_name_10);
          ...
          String _asName_5 = this._naming.asName(_name_12);
          _builder.append(_asName_5, "\t");
          _builder.append("\" + \"[\" + selfObjectName+ \":\" + selfClassName + \"]\");");
          _builder.newLineIfNotEmpty();
          _builder.append("}");
          ...
          String _asIdentifier_2 = this._naming.asIdentifier(_name_13);
          _builder.append(_asIdentifier_2, "");
          _builder.append("() {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            if (_createInterfaceObserver_3) {
              ...
              String _asEscapedName_3 = this._naming.asEscapedName(_name_14);
          ...
          _builder.append(className, "\t");
          _builder.append(".\" +\"");
          String _name_15 = event.getName();
          String _asIdentifier_3 = this._naming.asIdentifier(_name_15);
          _builder.append(_asIdentifier_3, "\t");
          _builder.append("\" + \"[\" + selfObjectName+ \":\" + selfClassName + \"]\");");
          _builder.newLineIfNotEmpty();
          _builder.append("}");
